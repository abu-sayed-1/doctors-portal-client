...
//^^^^^^^^^^^^^^^^ze kono jagay use korar jonno ei code use korcho ei code tumar index.js e auto set hoye zave hoy gele ze kono components theke use modal,popup  signUp, signIn ect from ta use korte parva 
